export default `I tak mam trzy razy mniej czasu, więc proszę mi pozwolić powiedzieć:
związkowcy
którymi się brzydzę
niszczą rodzinę
bo taka jest ich natura
co zostało dokładnie zaplanowane w Magdalence przez śp. generala Kiszczaka.
...
Ja nie potrzebowalem edukacji seksualnej, żeby wiedzieć, że
...
federaści
odkad zniesiono karę smierci
wprowadzają ustrój, w którym raz na cztery lata można wybrać sobie panal
...
dlatego trzeba zlikwidowac koryto, a nie zmieniać świnie.
Powtarzam:
...
odbierają dzieci
zamiast obniżyć podatki rodzicom
...
umieszczają dzieci w szkolach koedukacyjnych
żeby mężczyźni przestali być agresywni
- dlatego trzeba przywrócić normalność.
Yyyyy...
pseudo-masoni
z Wielkiego Wschodu Francji
za wszelką cenę wprowadzają parytety,
...
co lat temu sto nikomu nie przyszłoby nawet do głowy.`.split('\n')
